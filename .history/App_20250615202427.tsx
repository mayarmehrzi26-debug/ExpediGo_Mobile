...
import BarcodeScannerLiv from "./src/livreur/components/BarcodeScannerLiv";
import ProfileLivreur from "./src/livreur/Profile/ProfileLivreur";
import BarcodeScannerCL from "./src/destinataire/components/BarcodeScannerCL";
import Historique from "./src/livreur/Profile/ProfileLivreur";
...
import ProfileExp from "./src/expediteur/Profile/Profile";
...
/>
        ...
        />
          <Stack.Screen
          name="BarcodeScannerLiv"
          component={BarcodeScannerLiv}
          options={{ headerShown: false }}
        />
          <Stack.Screen
          name="BarcodeScannerCL"
          component={BarcodeScannerCL}
          options={{ headerShown: false }}
        />
        <Stack.Screen 
        name="PackageDetails"
