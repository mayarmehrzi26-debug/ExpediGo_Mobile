...
import PickupAddresses from "./screens/Profile/PickupAddresses";
...
const App: React.FC = () => {
  ...
  return (
    <PaperProvider>
    <NavigationContainer>
      <Stack.Navigator initialRouteName="HomeLivreur">
        <Stack.Screen
          name="Onboarding"
        ...
        />
         <Stack.Screen 
          ...
          options={{ headerTitle: () => <HeaderTitle /> }} // Utilisation du composant personnalisé
        />
 <Stack.Screen
          name="HomeLivreur"
