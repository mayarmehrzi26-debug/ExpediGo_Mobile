...
export const useEmballagePresenter = () => {
  ...
  const handleOrder = useCallback(async () => {
    ...
    try {
      ...
      if (err.message.includes("incomplète")) {
        errorMessage = err.message;
      } else if (err.message.includes("n'existe plus")) {
        errorMessage = err.message + " Rechargez vos adresses.";
  ...
  }, [quantity, selectedSizeData, totalPrice, selectedAddress, refreshAddresses]);
