...
<CustomDropdown
  ...
  options={[
    selectedAddress 
      ? {
          label: addresses.find(addr => addr.value === selectedAddress)?.label || selectedAddress,
          value: selectedAddress
        }
      : { label: "Sélectionnez une adresse", value: "" },
    {
      label: (
...
<CustomDropdown
  ...
  options={[
    selectedClient
      ? {
          label: clients.find(client => client.value === selectedClient)?.label || selectedClient,
...
<CustomDropdown
  ...
  options={[
    selectedProduct
      ? {
          label: products.find(product => product.value === selectedProduct)?.label || selectedProduct,
