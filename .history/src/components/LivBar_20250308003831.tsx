...
const FilterOption = ({ label, isActive, onPress }) => {
  return (
    <TouchableOpacity onPress={onPress}>
      ...
      <Image
        source={{ uri: "https://cdn.builder.io/api/v1/image/assets/f3828464c96d4349b61f8cc61d540aaa/a7fc3705d38c9507e44e36ffe3224b1a0114fb2499fa4efa3b652000b829a173?placeholderIfAbsent=true" }}
