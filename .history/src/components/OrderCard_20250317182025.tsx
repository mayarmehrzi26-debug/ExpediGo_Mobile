...
// Clé API Twilio SendGrid
sgMail.setApiKey('YOUR_SENDGRID_API_KEY');

const sendEmailToClient = async (email: string, orderId: string) => {
  const msg = {
    to: email,
    from: 'ton-email@example.com', // L'email vérifié sur SendGrid
    subject: 'Mise à jour de votre commande',
    text: `Votre colis est pris par le livreur. Vous pouvez suivre votre colis avec l'ID : ${orderId}.`,
    html: `<p>Votre colis est pris par le livreur.</p><p>Suivez votre colis avec l'ID : <strong>${orderId}</strong></p>`,
  };
