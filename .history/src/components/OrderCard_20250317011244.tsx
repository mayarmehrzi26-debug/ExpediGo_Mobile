  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        // Vérifiez que orderData contient clientEmail
        if (!orderData.clientEmail) {
          console.error('Adresse e-mail du client manquante');
          alert('Adresse e-mail du client manquante');
          return;
        }
    
        // Copiez le document vers "Orders"
        ...
        // Supprimez le document de "livraisons"
        ...
        if (!response.ok) {
          console.error('Erreur lors de l\'envoi de l\'e-mail:', responseBody);
