...
const OrderCard: React.FC = () => {
  ...
  const sendEmail = async (to, orderId) => {
    const apiKey = 'const sendEmail = async (to, orderId) => {
  const apiKey = 'YOUR_POSTMARK_API_KEY'; // Remplacez par votre clé API Postmark
  const url = 'https://api.postmarkapp.com/email';

  const emailData = {
    From: 'noreply@yourdomain.com', // Remplacez par votre adresse d'expédition
    To: to,
