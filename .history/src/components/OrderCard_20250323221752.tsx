...
const OrderCard: React.FC<OrderCardProps> = ({ statusFilter }) => {
  ...
  return (
    <View>
      {filteredOrders.length > 0 ? (
        ...
        <Text style={styles.noOrders}>Aucune livraison {statusFilter ? `avec le statut "${statusFilter}"` : "effectuée"}</Text>
      )}
