  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        // 🔹 Définir le message à envoyer, incluant le QR code
        const message = `
          <p>Votre colis est pris en charge.</p>
          <p>Vous pouvez suivre votre colis à travers l'ID de commande: <strong>${selectedOrder.id}</strong>.</p>
          <p>Voici votre code QR pour le suivi:</p>
        ...
        await sendEmail(emailTitle, clientEmail, message); // Envoi de l'email
