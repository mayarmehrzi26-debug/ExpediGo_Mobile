...
const NavBottomClient: React.FC<NavBottomProps> = ({
  activeScreen = "HomeClient",
}) => {
    ...
    <View style={styles.container}>
      <View style={styles.navBar}>
        <TouchableOpacity
          ...
          onPress={() => navigateToScreen("Colis")}
        >
          <Ionicons
            name="cube-outline"
            size={32}
            color={getIconColor("Colis")}
          />
          <Text style={getTextStyle("Colis")}>Mes colis</Text>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <Text style={getTextStyle("Chatbot")}>Contact</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.homeButton}
          onPress={() => navigateToScreen("HomeClient")}
        >
        ...
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => navigateToScreen("ProfileClient")}
        >
          <Ionicons
            name="person-outline"
            size={32}
            color={getIconColor("ProfileClient")}
          />
          <Text style={getTextStyle("ProfileClient")}>Profilez</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default NavBottomClient;
