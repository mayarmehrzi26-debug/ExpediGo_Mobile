...
const CashBox: React.FC<CashBoxProps> = ({ availableCash, unavailableCash, totalCash }) => {
  ...
  return (
    <Animated.View style={[styles.cashBox, { height: cardHeight }]}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.balanceContainer}>
            <View style={styles.balanceRow}>
              ...
              <Text style={styles.balanceValue}>{availableCash}</Text>
            </View>
            <View style={styles.balanceRow}>
              <Text style={styles.balanceLabel}>Cash non Disponible</Text>
              <Text style={styles.balanceValue}>{unavailableCash}</Text>
            </View>
            <View style={styles.balanceRow}>
              <Text style={styles.balanceLabel}>Total</Text>
              <Text style={styles.balanceValue}>{totalCash}</Text>
            </View>
          </View>
