...
const styles = StyleSheet.create({
  card: {
    ...
    elevation: 5,
    marginTop: 16,
    marginHorizontal: 16, // Ajouter une marge horizontale
  },
  cardHeader: {
    flexDirection: "row",
    alignItems: "center",
  ...
  icon: {
    ...
    height: 60,
    marginRight: 10,
    borderRadius: 8, // Ajouter un bord arrondi à l'image
  },
  cardDetails: {
    flex: 1,
  },
  ...
  orderText: {
    color: "#555",
    fontSize: 14,
    marginTop: 4, // Ajouter un espace entre les lignes
  },
  dateContainer: {
    flexDirection: "row",
    alignItems: "center",
  ...
  status: {
    marginTop: 12,
    alignSelf: 'flex-end', // Aligner le badge à droite
  },
  noOrders: {
    textAlign: "center",
    marginTop: 20,
