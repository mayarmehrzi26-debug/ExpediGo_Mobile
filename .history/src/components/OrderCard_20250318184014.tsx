...
const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        const message = `Votre colis a été pris en charge. Vous pouvez suivre votre colis avec l'ID de commande : ${selectedOrder.id}. Voici un code QR pour un accès rapide :  />`;
