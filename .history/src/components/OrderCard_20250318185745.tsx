  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        const clientName = clientSnapshot.data().name || "Client"; // Si le nom n'existe pas, utiliser "Client"
        const emailTitle = "Confirmation de livraison"; // Titre de l'email
        await sendEmail(emailTitle, clientName, clientEmail); // Envoi de l'email
