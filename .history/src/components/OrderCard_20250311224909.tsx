...
const OrderCard: React.FC = () => {
  ...
  const [hasFetched, setHasFetched] = useState(false); // Éviter les doubles appels
  ...
  }, [hasFetched]); // Éviter les doubles appels
  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        // Mettre à jour le statut de la commande à "En cours de livraison"
        ...
        // Mettre à jour la liste des commandes locales
