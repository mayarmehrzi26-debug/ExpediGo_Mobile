...
import sendEmail from '../../src/services/sendEmail'; // Assure-toi du bon chemin d'importation
  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        // Get the document snapshot from "livraisons"
        ...
        // Assuming client email is stored in orderData.clientEmail
        const clientEmail = orderData.clientEmail; // Adjust this according to your data structure
        const message = `Votre colis est pris en charge. Vous pouvez suivre votre colis à travers l'ID de commande: ${selectedOrder.id} ou via le code QR.`;
    
        // Send email to the client
        await sendEmail("Confirmation de livraison", clientEmail, message);
    
        // Copy the document from "livraisons" to "Orders"
