...
interface InvoiceDocumentProps {
  documentNumber: number; // ID numérique
  ticketNumber: string;
  ticketTitle: string;
    ...
    <View style={styles.container}>
      <View style={styles.documentWrapper}>
        ...
        <View style={styles.header}>
          <Text style={styles.documentNumber}>#{documentNumber}</Text> {/* Afficher l'ID numérique */}
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.valueColumn}>
            ...
            <Text style={styles.value}>{ticketTitle}</Text>
            <Text style={[styles.value, styles.serviceValue]}>
              {ticketService}
            </Text>
            <Text style={[styles.value, styles.statusValue]}>{ticketStatus}</Text>
