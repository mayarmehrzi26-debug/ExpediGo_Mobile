...
const OrderCard: React.FC = () => {
  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        // 🔹 Créer le message dynamique avec l'ID de commande
        const emailTitle = "Confirmation de livraison"; // Titre de l'email
        const message = `Votre colis a été pris en charge. Vous pouvez suivre votre colis avec l'ID de commande : ${selectedOrder.id}`;
  ...
  envoyer alors codeqr dans le message avec orderid
