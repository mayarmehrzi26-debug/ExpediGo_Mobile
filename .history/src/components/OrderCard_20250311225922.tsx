...
import { Animated, Modal, StyleSheet, Text, TouchableOpacity, View, Image, ActivityIndicator } from "react-native";
import { Ionicons } from "@expo/vector-icons";
import MaterialIcons from "@expo/vector-icons/MaterialIcons";
import { collection, doc, getDocs, setDoc, Timestamp, query } from "firebase/firestore";
import { firebasestore } from "../../FirebaseConfig"; // Firebase import
...
const OrderCard: React.FC<{ orders: Order[] }> = ({ orders }) => {
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalActions}>
                <TouchableOpacity style={styles.modalButton} onPress={handleConfirmDelivery}>
