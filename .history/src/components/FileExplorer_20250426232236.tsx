...
import { Text,Alert, Image, StyleSheet, TouchableOpacity, View } from 'react-native';
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            ...
            <div>© ${new Date().getFullYear()} Votre Société - Tous droits réservés</div>
          </div>

          <!-- Hidden QR code for capture -->
          <div style="position: absolute; left: -1000px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">
              ${new QRCode({ value: delivery.id, size: 200 }).svg()}
            </svg>
          </div>
        </body>
      </html>
