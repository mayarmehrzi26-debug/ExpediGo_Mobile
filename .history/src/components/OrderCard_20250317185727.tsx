...
const sendEmail = async (to, orderId) => {
  const apiKey = 'f21fcdd352f56aaf6bbd88b7fb5a7d32-3d4b3a2a-92559961'; // Replace with your Mailgun API key
  const domain = 'YOUR_DOMAIN_NAME'; // Replace with your Mailgun verified domain
  ...
  try {
    const response = await fetch(`https://api.mailgun.net/v3/${domain}/messages`, {
      ...
      body: new URLSearchParams({
        from: 'Your Name <you@yourdomain.com>', // Replace with your sender email
        to: to,
