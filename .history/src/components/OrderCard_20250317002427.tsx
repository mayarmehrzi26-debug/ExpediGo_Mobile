  ...
  const handleConfirmDelivery = async () => {
    if (selectedOrder) {
      try {
        ...
        await fetch('https://us-central1-ton-projet.cloudfunctions.net/sendEmail', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          body: JSON.stringify({
            email: orderData.clientEmail, // L'email du client
            orderId: selectedOrder.id, // L'ID de la commande
