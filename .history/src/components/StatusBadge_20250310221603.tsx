    ...
    const fetchStatus = async () => {
      try {
        ...
        if (!querySnapshot.empty) {
          const data = querySnapshot.docs[0].data(); // Récupérer le premier document
          ...
          setStatus(statusData?.status || "Statut inconnu"); // Définir le statut ou un message par défaut
        } else {
