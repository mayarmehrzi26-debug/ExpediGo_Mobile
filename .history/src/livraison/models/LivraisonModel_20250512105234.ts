...
export class LivraisonModel {
  ...
  async creditExpediteur(expediteurId: string, montant: number, commandeId: string): Promise<void> {
    try {
      ...
      batch.update(expediteurRef, {
        solde: increment(montant),
        lastUpdated: serverTimestamp()
      });
      console.log('[DEBUG] Mise à jour solde préparée');
      ...
      console.log('[DEBUG] Mise à jour paiement préparée');
      ...
      console.log('[DEBUG] Transaction préparée');
