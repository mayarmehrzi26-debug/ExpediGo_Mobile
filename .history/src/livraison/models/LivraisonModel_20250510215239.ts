import { addDoc, increment,collection, doc, getDoc, getDocs, limit, orderBy, query, updateDoc, where } from "firebase/firestore";
...
export class LivraisonModel {
  ...
  async incrementClientReturns(clientId: string): Promise<void> {
    try {
      ...
      console.error("Error incrementing returns count:", error);
      throw error;
    }
  }
