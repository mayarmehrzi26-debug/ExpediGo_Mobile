...
async saveDelivery(
  ...
  // Validation
  if (!selectedAddress || !selectedClient || !selectedPayment || selectedProducts.length === 0) {
    return { 
      success: false, 
      message: "Veuillez remplir tous les champs obligatoires et ajouter au moins un produit." 
    };
  }
  ...
  try {
    ...
    // Incrémentation du compteur (non bloquant)
