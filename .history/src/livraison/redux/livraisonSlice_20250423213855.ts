...
export const selectError = (state: RootState) => state.delivery.error;export const selectAddresses = (state: RootState) => state.livraison.addresses;
export const selectClients = (state: RootState) => state.livraison.clients;
export const selectProducts = (state: RootState) => state.livraison.products;