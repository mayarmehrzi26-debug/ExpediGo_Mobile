...
const NouvelleLivraisonScreen: React.FC = () => {
  ...
  // Utilisez le sélecteur avec une valeur par défaut complète
  const livraisonState = useSelector((state: RootState) => state.livraison) || {
    adresses: [],
    clients: [],
    products: [],
    paiementOptions: [],
  ...
  // Destructurez après avoir garanti que livraisonState existe
  const {
    adresses,
    clients,
    products,
