...
import { auth } from "../../FirebaseConfig"; // Importez l'objet auth depuis votre configuration Firebase
...
export const handleClientSubmit = async (
  ...
  try {
    ...
    const newClient: ClientModel = {
      ...
      userId: userCredential.users.uid // Utilisez l'UID du userCredential retourné
    };
