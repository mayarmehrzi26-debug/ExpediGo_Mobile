            ...
            {products.map((product, index) => (
              <View key={index} style={styles.detailRow}>
                <View style={styles.detailLabelContainer}>
                  ...
                  <Text style={styles.detailLabel}> Produit {products.length > 1 ? index + 1 : ''}:</Text>
                </View>
                <View style={{flex: 1}}>
                  <Text style={styles.detailValue}>{product.name}</Text>
                  <Text style={styles.detailValue}>Quantité: {product.quantity}</Text>
                  <Text style={styles.detailValue}>Prix: {product.price * product.quantity} DT</Text>
                </View>
                {product.image && (
                  <Image 
