...
const Profile: React.FC = () => {
      ...
      if (user) {
        ...
        if (userDoc.exists()) {
          setUserData({
            ...
            photoURL: user.photoURL || "https://media.istockphoto.com/id/1495088043/vector/user-profile-icon-avatar-or-person-icon-profile-picture-portrait-symbol-default-portrait.jpg?s=612x612&w=is&k=20&c=XmEKmysBRbA1o6zWBHLRaX2j_nrYVvdVZjuXPBLuOOo=",
  ...
  const menuItems = [
    ...
    { label: "Informations du Business", route: "BusinessInfo" },
    { label: "Mes Clients", route: "ListeClients" },
    { label: "Adresses des pickup", route: "ListeAdresses" },
    { label: "Mes Produits", route: "ProductList" },

    { label: "Mauvais clients", route: "BadClients" },
