  ...
  return (
    <View style={styles.container}>
      ...
      <FilterBar 
        ...
        filterOptions={["Toutes les livraisons", "Non traité","En attente d'enlèvement","Picked","Annullée","En cours de livraison", "Livré", "Retour", "Échange"]}
      />
        ...
        {filteredDeliveries.length > 0 ? (
          filteredDeliveries.map((delivery) => (
            <DeliveryCard
              ...
              showEditButton={canModifyOrCancel}
              showCancelButton={canModifyOrCancel}
            />
          ))
        ) : (
