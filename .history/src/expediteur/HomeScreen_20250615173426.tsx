...
import { arrayUnion, collection, doc, getDocs, orderBy, query, updateDoc, where, writeBatch } from 'firebase/firestore';
...
type HomeScreenNavigat ionProp = StackNavigationProp<RootStackParamList, 'HomeScreen'>;
  ...
  try {
    ...
    if (user) {
      ...
      notificationsList
        ...
        .forEach(notif => {
          const notifRef = doc(firebasestore, 'notifications', notif.id);
      ...
      {cameraVisible ? (
        ...
        <>
          ...
          <View style={styles.bottomNav}>
            ...
            <TouchableOpacity
              style={styles.bottomNavItem}
              onPress={() => navigation.navigate('ProfileExp')}
            >
