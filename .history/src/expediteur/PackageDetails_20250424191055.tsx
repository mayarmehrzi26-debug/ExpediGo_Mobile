    ...
    const fetchDeliveryDetails = async () => {
      try {
        ...
        setDelivery({
          ...
          clientAddress: clientDoc.data()?.address || 'Adresse client inconnue',
  ...
  if (!delivery) {
    return (
      <View style={styles.container}>
        <Header title="Détails de colis" showBackButton={true} onBackPress={() => navigation.goBack()} />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionText}>
              De <Text style={styles.boldText}>{delivery.address}</Text> vers {'\n'}
              <Text style={styles.boldText}>{delivery.clientAddress}</Text>
            </Text>
            ...
            {delivery.status === "En cours de livraison" && (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate('TrackingScreen', { 
                  ...
                  toAddress: delivery.clientAddress
                })}
              >
                <Icon name="map-marker-path" size={20} color="#9C27B0" />
