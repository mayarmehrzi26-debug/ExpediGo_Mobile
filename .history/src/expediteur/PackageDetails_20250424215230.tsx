      ...
      <View style={styles.contactButtons}>
        ...
        <TouchableOpacity style={styles.contactButton}>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionText}>Colis de <Text style={styles.boldText}>{delivery.address}</Text> vers <Text style={styles.boldText}>{delivery.clientAdress}</Text> pour le client <Text style={styles.boldText}>{delivery.client}</Text>.
            </Text>
