...
const showTransactionSelectionDialog = (transactions: PendingTransaction[]): Promise<string[]> => {
  return new Promise((resolve) => {
    Alert.alert(
      ...
      "Choisissez les transactions à inclure dans le versement",
      [
        {
          text: "Annuler",
          onPress: () => resolve([]),
        ...
        {
          text: "Valider",
          onPress: () => resolve(selectedTransactions)
        }
      ],
      { cancelable: true }
    );
...
const handleRequestWithdrawal = async () => {
  ...
  try {
    // Récupère les transactions non traitées
        ...
        <View style={styles.modalFooter}>
          ...
          <View style={styles.modalButtons}>
            <TouchableOpacity
              ...
              onPress={() => setShowTransactionSelection(false)}
            >
