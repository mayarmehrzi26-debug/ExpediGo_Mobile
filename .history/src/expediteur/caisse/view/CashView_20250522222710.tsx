...
const showTransactionSelectionDialog = (transactions: PendingTransaction[]): Promise<string[]> => {
  return new Promise((resolve) => {
    ...
    // Cette partie devra gérer la résolution de la promesse lorsque l'utilisateur valide
    // Vous aurez besoin d'un état supplémentaire ou d'une ref pour capturer la sélection
  });
};
