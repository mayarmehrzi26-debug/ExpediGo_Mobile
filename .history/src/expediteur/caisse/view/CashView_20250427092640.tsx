...
const CashView = () => {
  ...
  const [presenter] = useState(new CaissePresenter({
    ...
    disableWithdrawalButton: () => setCanRequestWithdrawal(false),
  ...
  const BalanceCard = () => (
    <View style={styles.balanceCard}>
      ...
      <View style={styles.balanceRow}>
        <Text style={styles.balanceText}>Cash non disponible:</Text>
      ...
      <TouchableOpacity 
        style={[
          styles.ButtonPaymnt, 
          (!canRequestWithdrawal || parseFloat(balance.pendingAmount) <= 0) && styles.disabledButton
        ]} 
        onPress={handlePendingWithdrawal}
        disabled={!canRequestWithdrawal || parseFloat(balance.pendingAmount) <= 0}
      >
      ...
      <View style={styles.transactionDetails}>
        ...
        <View style={styles.statusContainer}>
          {transaction.status === "Traitée" && (
            <Entypo name="dot-single" size={12} color="#7B61FF" />
          )}
