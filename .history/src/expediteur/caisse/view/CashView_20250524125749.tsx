...
const CashView = () => {
  ...
  return (
    <View style={styles.requestCard}>
      ...
      {/* Ajout de l'affichage de la raison de rejet */}
        ...
        <View style={styles.rejectionContainer}>
          ...
          >
            <View style={styles.rejectionBadge}>
              <Entypo name="info-with-circle" size={16} color="#FF5252" />
              <Text style={styles.rejectionButtonText}>Raison du rejet</Text>
            </View>
            <Entypo 
              name={showReason ? "chevron-up" : "chevron-down"} 
              size={16} 
              color="#FF5252" 
            />
          </TouchableOpacity>
