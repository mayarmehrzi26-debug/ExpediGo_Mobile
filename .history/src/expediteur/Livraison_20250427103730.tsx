...
<View style={styles.headerContainer}>
  ...
  <TouchableOpacity style={styles.timelineButton} onPress={() => navigation.navigate("HistoriqueCommandes")}>
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between', // Ajouté pour bien séparer Header et icône
