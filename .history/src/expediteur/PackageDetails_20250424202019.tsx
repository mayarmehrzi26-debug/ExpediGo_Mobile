...
<View style={styles.contactSection}>
  <Text style={styles.sectionTitle}>Contact Destinataire</Text>
  <View style={styles.rowBetween}>
    <View>
      <Text style={styles.sectionTitle}>{delivery.client}</Text>
      <Text style={styles.descriptionText}>{delivery.clientAdress}</Text>
    </View>
...
{/* Contact Livreur */}
{delivery.status !== "Non traité" && delivery.status !== "En attente" && (
  <View style={styles.contactSection}>
    <Text style={styles.sectionTitle}>Contact Livreur</Text>
    <View style={styles.rowBetween}>
      <View>
        <Text style={styles.descriptionText}>Nom Livreur (à récupérer)</Text>
        <Text style={styles.descriptionText}>Adresse ou info livreur</Text>
      </View>
      <View style={styles.contactButtons}>
        <TouchableOpacity style={styles.contactButton}>
          <Icon name="message-text" size={20} color="#574599" />
        ...
        <TouchableOpacity style={styles.contactButton}>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionText}>Colis de <Text style={styles.boldText}>{delivery.address}</Text> vers <Text style={styles.boldText}>{delivery.clientAdress}</Text> pour le client{' '}
