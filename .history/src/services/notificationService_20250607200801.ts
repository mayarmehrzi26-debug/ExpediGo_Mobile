...
import { arrayUnion, collection,serverTimestamp,addDoc doc, getDoc, getDocs, orderBy, query, updateDoc, where } from 'firebase/firestore';
...
export const registerForPushNotificationsAsync = async (userId: string) => {
  ...
  // Enregistrez seulement le token dans Firestore
  if (userId) {
