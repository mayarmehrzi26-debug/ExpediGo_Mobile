...
const CommandeDetailsScreen = ({ route, navigation }) => {
  ...
  const [commande, setCommande] = useState({
    ...
    status: initialCommande.status || "Non traité" // Ajoutez cette ligne
  ...
  const getActionButtonInfo = () => {
    switch (commande.status) {
      case "Non traité": 
        return { 
          text: "Commencer le pickup", 
          color: "#44076a",
          disabled: false 
        };
      case "En cours de pickup": 
        return { 
          text: "En cours de pickup (arrivée automatique)", 
          color: "#877DAB", 
          disabled: true 
        };
      case "Picked": 
      ...
      case "En cours de livraison": 
        return { 
          text: "En cours de livraison (arrivée automatique)", 
          color: "#ac0d8c", 
          disabled: true 
        };
      default: 
