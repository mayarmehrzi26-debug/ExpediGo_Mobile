...
const CommandeDetailsScreen = ({ route, navigation }) => {
  ...
  const startTracking = async (status) => {
    try {
      ...
      // Arrêter tout abonnement existant
      ...
      // Mettre à jour la position initiale dans Firestore
      await updateLivreurTracking(location.coords, status);
      ...
      const sub = await Location.watchPositionAsync(
        ...
        async (newLocation) => {
          ...
          await updateLivreurTracking(newCoords, status);
        }
      );
