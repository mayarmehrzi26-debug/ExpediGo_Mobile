...
interface Solde {
  ...
  const handleMainAction = () => {
    switch (commande.status) {
      case "Non traité":
        handleStatusUpdate("En attente d'enlèvement"); // Changé de "En cours de pickup" à "En attente d'enlèvement"
        break;
      case "En attente d'enlèvement": // Ajout de ce cas
  ...
  const showActionButton = ["En attente d'enlèvement", "En cours de pickup", "En cours de livraison"].includes(commande.status);
