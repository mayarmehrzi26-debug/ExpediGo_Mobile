...
const CommandeDetailsScreen = ({ route, navigation }) => {
  ...
  onPress={() => navigation.navigate('CommandeHistory', { commandeId: commande.id })}
>
  <MaterialIcons name="history" size={24} color="#44076a" />
    ...
    <View style={styles.contactInfo}>
      <Text style={styles.contactName}>
        {commande.createdBy?.name || 
         commande.createdBy?.displayName || 
         (typeof commande.createdBy === 'string' ? `Expéditeur (ID: ${commande.createdBy})` : 'Non spécifié')}
      </Text>
      
    </View>
    
    {commande.createdBy && typeof commande.createdBy !== 'string' && (
