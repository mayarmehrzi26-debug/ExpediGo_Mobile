  ...
  const handleStatusUpdate = async (newStatus) => {
    ...
    try {
      ...
      if (success) {
        ...
        // Si le statut est "Retour", incrémentez le compteur
        if (newStatus === "Retour" && commande.client?.id) {
          try {
            await livraisonModel.incrementClientReturns(commande.client.id);
            console.log("Compteur de retours incrémenté avec succès");
          } catch (error) {
