...
const CommandeDetailsScreen = ({ route }) => {
  ...
  const getActionButtonInfo = () => {
    switch (commande.status) {
      ...
      case "En cours de livraison": return { text: "Terminer la livraison", color: "#4CAF50" };
        ...
        <View style={styles.section}>
          ...
          <View style={styles.contactCard}>
            <View style={styles.contactInfo}>
              <Text style={styles.contactName}>{commande.livraison.createdBy.name || 'Non spécifié'}</Text>
                ...
                <>
                  <TouchableOpacity 
                    ...
                    onPress={() => handleOpenChat({
                      name: commande.expediteurName,
                      phone: commande.createdBy.phone
                    })}>
                  ...
                  <TouchableOpacity 
                    style={styles.iconButton}
                    onPress={() => confirmCall(commande.createdBy.phone, commande.expediteurName)}>
            ...
            <View style={styles.contactActions}>
              {commande.clientPhone && (
                <>
                  ...
                  <TouchableOpacity 
                    style={styles.iconButton}
                    onPress={() => confirmCall(commande.clientPhone, commande.clientName)}>
                    <MaterialIcons name="phone" size={24} color="#44076a" />
                  </TouchableOpacity>
                </>
              )}
