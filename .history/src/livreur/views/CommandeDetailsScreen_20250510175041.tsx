    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.contactCard}>
            <View style={styles.contactInfo}>
              <Text style={styles.contactName}>{commande.destinataire?.name || 'Non spécifié'}</Text>
    ...
    <>
      <TouchableOpacity 
        ...
        onPress={() => destinataire ? 
          handleStartConversation(destinataire.id, {commande.destinataire?.name || 'Non spécifié'}) : 
