...
const styles = StyleSheet.create({
  ...
  filterButton: {
    paddingHorizontal: 16, // Réduire le padding horizontal
    paddingVertical: 8,
    height: 36, // Hauteur fixe
    minWidth: 100, // Largeur minimale
    borderRadius: 18,
    borderWidth: 1,
    borderColor: '#DDD',
  ...
  filterText: {
    color: '#666',
    fontSize: 14, // Taille de police fixe
    textAlign: 'center', // Centrer le texte
  },

  // Pour le conteneur des filtres
  filterContainer: {
    marginHorizontal: 16,
    marginBottom: 12,
    height: 40, // Hauteur fixe pour le conteneur
  },
  filterContent: {
    paddingRight: 16,
