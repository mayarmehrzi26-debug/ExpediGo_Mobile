...
import BarcodeScanner from '../../screensBarcodeScanner'; // Ajustez le chemin selon votre structure
      ...
      {cameraVisible ? (
        ...
        <>
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            {/* Passer le statut "Non traité" comme filtre */}
            <OrderCard statusFilter="Non traité" navigation={navigation} />
          </ScrollView>
