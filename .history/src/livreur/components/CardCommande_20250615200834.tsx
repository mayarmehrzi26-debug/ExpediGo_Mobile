...
const handleStatusUpdate = async (newStatus: string) => {
  try {
    ...
    if (success) {
      ...
      const notificationTitle = `Mise à jour de votre commande #${commande.id}`;
      let notificationBody = '';
      
      switch (newStatus) {
        case "En attente d'enlèvement":
          notificationBody = "Un livreur a pris en charge votre commande";
          break;
        case "En cours de pickup":
          notificationBody = "Votre colis est en cours de récupération";
          break;
        case "Picked":
          notificationBody = "Votre colis a été récupéré et sera bientôt livré";
          break;
        case "En cours de livraison":
          notificationBody = "Votre colis est en cours de livraison";
          break;
        case "Livré":
          notificationBody = "Votre colis a été livré avec succès";
          break;
        default:
          notificationBody = `Statut de votre commande mis à jour: ${newStatus}`;
      }

      // Envoyer aux utilisateurs concernés (client et créateur)
      await sendPushNotification(
        [commande.client.id, commande.createdBy.id],
        notificationTitle,
        notificationBody,
        {
  ...
  const getStatusColor = () => {
    switch (commande.status) {
      case "Non traité": return "#877DAB"; // Orange
      case "En attente d'enlèvement": return "#877DAB"; // Blue
      case "En cours de pickup": return "#6025ad"; // Amber
      case "Picked": return "#877DAB"; // Purple
      case "En cours de livraison": return "#ac0d8c"; // Green
      case "Livré": return "#2E7D32"; // Dark Green
      case "Retour": return "#D32F2F";
case "Echange": return "#b91c5d";
