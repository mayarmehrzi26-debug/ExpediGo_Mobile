...
interface CardProps {
  commande: {
    id: string;
    type: string;
    address?: string; // Adresse du client (destination)
    client?: string;
    pickupAddress?: string; // Nouvelle propriété : adresse d'origine
    date?: string;
  };
  onRefresh: () => void;
}
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardDetails}>
          ...
          <Text style={styles.orderText}>Origine : {commande.pickupAddress || "Non spécifiée"}</Text>
          <Text style={styles.orderText}>Destination : {commande.address || "Non spécifiée"}</Text>
        </View>
