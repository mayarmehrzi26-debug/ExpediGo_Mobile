...
const CardCommande: React.FC<CardProps> = ({ commande, onRefresh }) => {
  ...
  const handleLivrer = async () => {
    await updateLivraisonStatus(commande.id, commande.type);
    onRefresh();
  };
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardDetails}>
          ...
          <Text style={styles.orderText}>Origine : {commande.origin || "Non spécifiée"}</Text>
          <Text style={styles.orderText}>Destination : {commande.destination || "Non spécifiée"}</Text>
        </View>
      </View>
