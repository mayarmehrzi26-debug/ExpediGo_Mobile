...
export default function BarcodeScannerLiv({ onClose }: BarcodeScannerProps) {
  ...
  const handleBarcodeScanned = ({ data }: { data: string }) => {
    setScannedData(data);
    navigation.navigate('CommandeDetailsScreen', { deliveryId: data }); // Naviguer vers la page des détails du colis
