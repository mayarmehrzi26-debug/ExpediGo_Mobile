...
interface Props {
  emballage: {
    ...
    addressId: string;
    clientEmail: string;
    fullAddress: string; // Juste le texte de l'adresse
    date?: string;
  };
  onRefresh: () => void;
}
      ...
      <View style={styles.cardHeader}>
        <View style={styles.cardDetails}>
          ...
          <View style={styles.detailContainer}>
            ...
            <Text style={styles.orderText}>Prix total: {emballage.totalPrice} dt</Text>
            <Text style={styles.orderText}>destination: {emballage.addressId}</Text>

            <Text style={styles.orderText}>Client: {emballage.createdBy}</Text>
          </View>
        </View>
      </View>
