...
import { addDoc, collection, doc, getDoc, getDocs, query, setDoc, updateDoc,deleteDoc } from "firebase/firestore";
...
export class ClientService {
  ...
  static async getClientById(clientId: string): Promise<any> {
    try {
