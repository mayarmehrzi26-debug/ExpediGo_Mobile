...
static async createUserAccount(
  ...
  try {
    ...
    const currentPassword = "password_admin"; // Vous devrez gérer ceci sécuritairement
    ...
    // 4. Déconnecter le nouveau user immédiatement
    await signOut(firebaseAuth);

    // 5. Reconnecter l'admin si nécessaire
    if (currentEmail) {
