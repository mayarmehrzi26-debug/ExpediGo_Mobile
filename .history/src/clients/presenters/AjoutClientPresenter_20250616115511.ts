 ...
 async handleSubmit(clientData: {
    ...
    try {
      ...
      try {
        ...
        // Si la création du compte échoue, on considère quand même que le client est ajouté
        console.warn("Création de compte échouée:", userError);
        this.view.showSuccess("Succès", "Client ajouté avec succès (mais création de compte échouée).");
      }
