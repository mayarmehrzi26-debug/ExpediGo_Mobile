...
export class AjoutClientPresenter {
  ...
  async handleSubmit(clientData: {
    ...
    try {
      ...
      const { id: clientId, emailSent, isNew } = await ClientService.addClientWithEmail({
      ...
      if (isNew) {
        ...
        if (!querySnapshot.empty) {
          ...
          await ClientService.updateUserClientId(userDoc.id, clientId);
        }
      }
      ...
      this.view.showSuccess(
        ...
        isNew 
          ...
          : "Client existant ajouté à votre liste.",
