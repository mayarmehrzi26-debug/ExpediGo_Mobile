...
export class AjoutClientPresenter {
  ...
  async handleSubmit(clientData: {
    ...
    try {
      ...
      // Supprimer la création de compte utilisateur ici
      // Car elle est déjà gérée dans addClientWithEmail

      this.view.showSuccess(
        "Succès", 
        "Client ajouté avec succès.",
        () => this.view.navigateBack() // Restez sur la même page après l'ajout
      );
