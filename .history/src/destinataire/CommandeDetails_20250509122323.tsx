  ...
  useEffect(() => {
    const fetchCommandeDetails = async () => {
      try {
        ...
        setCommande({
          id: commandeId,
          expediteur:commandeDetails.expediteur,
          origin: commandeDetails.originAddress || 'Adresse inconnue',
          destination: commandeDetails.destination || 'Adresse inconnue',
          clientName: commandeDetails.clientName,
          clientPhone: commandeDetails.clientPhone,
        ...
        <View style={styles.card}>
          <View style={styles.contactSection}>
            <View style={styles.rowBetween}>
              <View>
                <Text style={styles.sectionTitle}>{commande.expediteur}</Text>
