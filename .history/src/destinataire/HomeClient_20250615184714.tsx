...
import { arrayUnion, collection,getDocs, doc, getDoc, orderBy, query, serverTimestamp, updateDoc, where } from 'firebase/firestore';
...
import BarcodeScanner from '../components/BarcodeScanner copy';
