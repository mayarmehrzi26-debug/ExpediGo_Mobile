    ...
    const fetchCommandeDetails = async () => {
      try {
        ...
        setCommande({
          ...
          clientName: commandeDetails.expediteurName, // On utilise expediteurName au lieu de clientName
          clientPhone: commandeDetails.expediteurPhone, // On utilise expediteurPhone
