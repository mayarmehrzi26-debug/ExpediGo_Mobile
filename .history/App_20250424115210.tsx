...
import NouvelleLivraisonView from "./screens//livraison/views/NouvelleLivraisonView";
...
const App: React.FC = () => {
  ...
  return (
    <PaperProvider>
    <NavigationContainer>
      <Stack.Navigator initialRouteName="NouvelleLivraisonView">
        <Stack.Screen
          name="Onboarding"
