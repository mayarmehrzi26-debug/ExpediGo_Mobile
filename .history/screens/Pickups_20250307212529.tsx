          ...
          filteredDeliveries.map((delivery) => (
            <View key={delivery.id} style={styles.deliveryCard}>
              ...
              <Text style={styles.deliverySubtitle}>
                Status: <Text style={styles.statusBadge}>Entréeau centrale</Text>
              </Text>
              <Text style={styles.deliverySubtitle}>
                date <Text style={styles.dateContainer}>Entréeau centrale</Text>
              </Text>
              <View style={styles.dateContainer}>
    <Text style={styles.deliveryDate}>Date:</Text>
    <Text style={styles.deliveryDateValue}>{delivery.date}</Text>
  </View>              <View style={styles.dateContainer}>
    <Text style={styles.deliveryDate}>Paiement:</Text>
    <Text style={styles.deliveryValue}>{delivery.payment} DT</Text>
  </View>              <View style={styles.dateContainer}>
    <Text style={styles.deliveryDate}>Date:</Text>
    <Text style={styles.deliveryValue}>{delivery.date}</Text>
  </View>              {delivery.isFragile && <Text style={styles.fragileBadge}>Colis fragile</Text>}
            </View>
          ))
        ) : (
