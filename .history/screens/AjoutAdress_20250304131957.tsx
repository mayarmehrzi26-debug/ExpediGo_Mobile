...
const AjoutAdress: React.FC<AjoutAdressProps> = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert("Succès", "adresse ajouté avec succès", [{ text: "OK", onPress: () => navigation.goBack() }]);
    } catch (error) {
      console.error("Erreur lors de l'ajout du adresse:", error);
      Alert.alert("Erreur", "Une erreur s'est produite lors de l'ajout du adresse");
    } finally {
      setLoading(false);
    }
  };
