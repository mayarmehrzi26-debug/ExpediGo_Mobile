...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(245, 245, 245, 0.7)', // 70% d'opacité
    borderRadius: 10,
    paddingHorizontal: 15,
    marginVertical: 8,
    borderWidth: 0.5,
    borderColor: 'rgba(0,0,0,0.05)',
    // Effet de flou léger (si BackdropFilter est disponible)
    backdropFilter: 'blur(5px)', // Fonctionne sur certains devices
},
  inputIcon: {
    marginRight: 10,
  },
