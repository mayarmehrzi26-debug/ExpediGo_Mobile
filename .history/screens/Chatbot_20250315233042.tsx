...
import FontAwesomeIcon from 'react-native-vector-icons/FontAwesome'; // Assurez-vous que le chemin est correct
...
function Chatbot() {
    ...
    return (
        ...
        <View style={styles.outerContainer}>
            ...
            <FontAwesomeIcon icon="fa-regular fa-robot" color="#ffffff"/></View>
