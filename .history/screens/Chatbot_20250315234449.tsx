...
import FontAwesomeIcon from 'react-native-vector-icons/FontAwesome'; // Importer FontAwesome
...
function Chatbot() {
    ...
    return (
        <View style={styles.outerContainer}>
             ...
             <View style={styles.botIconContainer}>
                <MaterialCommunityIcons name="robot" size={50} color="#ffffff" /> {/* Utiliser l'icône de robot */}
            </View>            </View>
