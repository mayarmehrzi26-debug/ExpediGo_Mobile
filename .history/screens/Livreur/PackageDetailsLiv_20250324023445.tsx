...
const styles = StyleSheet.create({
  ...
  detailsScrollView: {
    flex: 1,
    marginBottom: 200, // Ajouter une marge en bas pour éviter que le contenu ne soit caché par la carte
  },
  card: {
    backgroundColor: '#fff',
    borderRadius: 32,
    ...
    left: 16, // Marge à gauche
    right: 16, // Marge à droite
    marginBottom: 16, // Espace en bas
