...
const PackageDetailsLiv: React.FC<PackageDetailsProps> = ({ route, navigation }) => {
  ...
  const handleStartDelivery = () => {
    ...
    console.log('Livraison commencée !');
    // Mettez à jour le statut ici (par exemple : "En cours de livraison")
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        {routeCoords.length > 0 && (
          <Polyline coordinates={routeCoords} strokeWidth={4} strokeColor="#0076C7" />
        )}
      </MapView>
      ...
      {/* Bouton Commencez à livrer */}
      <TouchableOpacity style={styles.startDeliveryButton} onPress={() => setModalVisible(true)}>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalText}>Vous allez commencer à livrer maintenant. Continuer ?</Text>
