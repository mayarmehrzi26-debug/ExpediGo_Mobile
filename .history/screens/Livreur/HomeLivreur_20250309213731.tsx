...
// Animation pour le texte "Nouvelles commandes"
const fadeAnim = useRef(new Animated.Value(0)).current;

useEffect(() => {
  // Démarre l'animation au chargement du composant
 ...
 {/* Texte animé "Nouvelles commandes" */}
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    marginBottom: 10, // Réduit l'espace en bas
  },
  logo: {
    width: 120,
    height: 60,
  ...
  animatedText: {
    ...
    color: '#F97316',
    textAlign: 'center',
    marginBottom: 20, // Réduit l'espace en bas
