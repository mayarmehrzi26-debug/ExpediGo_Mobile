...
const styles = StyleSheet.create({
  ...
  map: {
    height: '100%', // Fait en sorte que la carte prenne toute la hauteur disponible
    width: '100%', // La carte occupe toute la largeur
  },
  overlay: {
    position: 'absolute',
    bottom: 10, // Place la card au bas de l'écran
    left: 16, // Décalage à gauche pour un léger espacement
    right: 16, // Décalage à droite pour un léger espacement
    backgroundColor: 'transparent',
    zIndex: 2, // Place la card par-dessus la carte
  },
  detailsScrollView: {
    flex: 1,
    marginBottom: 70, // Ajuste la marge pour éviter que le contenu soit trop proche du bas
  },
  card: {
    backgroundColor: '#fff',
    borderRadius: 32,
    ...
    shadowOpacity: 0.1,
    shadowRadius: 5,
    elevation: 5, // Pour ajouter une ombre sous la carte sur Android
  },
  cardHeader: {
    flexDirection: 'row',
