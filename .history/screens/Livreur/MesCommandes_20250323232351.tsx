...
import LivBar from "../../src/components/LivExplorer";
...
const MesCommandes: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <FilterBar
        deliveries={filteredDeliveries} // Passer les commandes filtrées
        filterOptions={[
      ...
      <LivBar searchQuery={searchQuery} setSearchQuery={setSearchQuery} />
