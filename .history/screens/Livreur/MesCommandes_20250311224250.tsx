...
const MesCommandes: React.FC = () => {
  ...
  const fetchOrders = async () => {
    try {
      const q = query(collection(firebasestore, "Orders"));
...
Lorsque l'utilisateur confirme la livraison, le statut de la commande est mis à jour à "En cours de livraison".

La commande est déplacée de la collection livraisons vers la collection Orders.

Dans MesCommandes :

Les commandes sont récupérées depuis la collection Orders.

Les commandes sont filtrées en fonction de leur statut ("En cours de livraison", "Livrée", etc.).

Filtrage des commandes :

Le filtre "En cours de livraison" affiche uniquement les commandes avec ce statut.

Résultat attendu
Lorsque l'utilisateur confirme une livraison dans OrderCard, la commande est déplacée vers la collection Orders avec le statut "En cours de livraison".

Dans MesCommandes, les commandes avec le statut "En cours de livraison" sont affichées dans la partie correspondante.
