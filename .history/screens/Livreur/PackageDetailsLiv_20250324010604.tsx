...
Colis de <Text style={styles.boldText}>{packageDetails.address}</Text> à <Text style={styles.boldText}>{packageDetails.destination}</Text> pour le client <Text style={styles.boldText}>{packageDetails.client}</Text>.
              </Text>
