...
<View style={[styles.statusBadge, getStatusColor(packageDetails.status)]}>
            ...
            <View style={styles.descriptionContainer}>
              <Text style={styles.descriptionText}>Colis de <Text style={styles.boldText}>{packageDetails.address}</Text> à <Text style={styles.boldText}>{packageDetails.destination}</Text> pour le client <Text style={styles.boldText}>{packageDetails.client}</Text>.
              </Text>
...
>
  <Text style={styles.routeButtonText}>Commencer la livraison </Text>
</TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  routeButton: {
    flexDirection: 'row', // Permet de placer l'icône et le texte horizontalement
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#877DAB', // Couleur d'arrière-plan
    paddingVertical: 12, // Espacement vertical
    paddingHorizontal: 20, // Espacement horizontal
    borderRadius: 25, // Arrondi des bords
    marginTop: 20,
    marginHorizontal:40 // Mar
  },
  routeButtonText: {
