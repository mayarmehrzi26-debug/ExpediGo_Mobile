          ...
          filteredDeliveries.map((delivery) => (
            ...
            <View key={delivery.id} style={styles.deliveryCard}>
              <View style={styles.cardHeader}>
                ...
                <Text style={styles.statusBadge}>Voir les détails</Text>
              </TouchableOpacity>
              </View>
              <Text style={styles.deliveryClient}>{delivery.client}</Text>
              <View style={styles.separator} />
              <div className="bg-[#FF4E51] text-white px-3 py-1 rounded-[8.96152px] text-[9px] flex items-center">
            <div className="w-[8.51418px] h-[8.51418px] bg-white rounded-full mr-2"></div>
            Annulée par vendeur
          </div>
