import { Entypo } from "@expo/vector-icons"; // Ajoutez cette ligne pour importer Entypo
      ...
      <View style={styles.transactionCard}>
        ...
        <View style={styles.transactionDetails}>
          ...
          {transaction.status === "Traitée" && (
            <Entypo name="dot-single" size={12} color="#54E598" />
          )}
...
const styles = StyleSheet.create({
  ...
  statusContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    marginTop: 5, // Optionnel : ajoutez un peu d'espace en haut
  },
  transactionList: {
    width: "100%",
  },
