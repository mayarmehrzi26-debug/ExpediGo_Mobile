...
import BottomSheetComponent from '..//src/components/BottomSheetComponent'; // Ajoute ce composant
      ...
      {cameraVisible ? (
        ...
        <>
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <StatsList />
 {/* Icône avec effet de glissement */}
 <TouchableOpacity style={styles.handle} onPress={() => setIsSheetVisible(true)}>
        <Ionicons name="remove-outline" size={40} color="gray" />
      </TouchableOpacity>

      {/* Affichage du Bottom Sheet */}
      {isSheetVisible && <BottomSheetComponent onClose={() => setIsSheetVisible(false)} />}
            {/*Mise à jour */}
