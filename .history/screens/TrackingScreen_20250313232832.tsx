...
const Sign = ({ locationAddress, destinationAddress }) => {
  return (
    <View style={styles.signContainer}>
      ...
      {destinationAddress && (
        <>
          <Text style={styles.signTitle}>Localisation du client</Text>
...
const CourierCard = ({ name, type, packageWeight = "1 KG", status = "Processing" }) => {
  return (
    <View style={styles.courierCard}>
      <View style={styles.courierHeader}>
        <View style={styles.courierNameContainer}>
          <View style={styles.courierIcon}>
            <Text style={styles.courierIconText}>{name.split(' ').map(part => part[0]).join('')}</Text>
          </View>
          <View>
        ...
        <View style={styles.courierActions}>
          ...
          <Button title={<MessageCircle />} onPress={() => {}} />
        </View>
      </View>
      ...
      <View style={styles.courierDetails}>
        <View style={styles.detailBox}>
          ...
          <Text style={styles.detailValue}>{packageWeight}</Text>
        </View>
        <View style={styles.detailBox}>
