...
export default function TrackingScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Carte partagée entre les deux conteneurs */}
      <View style={styles.mapContainer}>
        ...
        >
          ...
          <Marker
            ...
            title="Your Location"
            pinColor="#F06292" // Couleur du marqueur de localisation
          />
          {destination && (
            <Marker
              coordinate={destination}
              title="Destination"
              pinColor="#877DAB" // Couleur du marqueur de destination
            />
          )}
          {route.length > 0 && (
            <Polyline
...
const styles = StyleSheet.create({
  ...
  topContainer: {
    height: '30%', // 50% de l'écran en mauve
    backgroundColor: '#877DAB',
  },
  container2: {
    flex: 1,
  ...
  mapContainer: {
    position: 'absolute',
    top: '10%', // Positionner la carte au milieu
    left: 20,
    right: 20,
    height: '35%', // 50% de l'écran
    borderRadius: 40,
    overflow: 'hidden',
    zIndex: 10, // Assure que la carte est au-dessus des autres éléments
  },
  map: {
    flex: 1,
  },
  ...
  distanceContainer: {
    position: 'absolute',
    top: 20, // Position en haut de la carte
    left: '50%',
    transform: [{ translateX: -130 }], // Centrer horizontalement
    ...
    shadowRadius: 4,
    elevation: 5,
    zIndex: 20, // Assure que le conteneur est au-dessus de la carte
  },
  distanceText: {
    fontSize: 16,
    fontWeight: 'bold',
  ...
  backButton: {
    ...
    top: 30,
    left: 20,
    zIndex: 20, // Assure que le bouton est au-dessus de la carte
    backgroundColor: '#877DAB',
    padding: 10,
    borderRadius: 30,
  },
