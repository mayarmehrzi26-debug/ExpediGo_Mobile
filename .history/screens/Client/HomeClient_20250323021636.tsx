...
const HomeClient: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  const searchOrderByTrackingCode = async () => {
    ...
    try {
      ...
      if (orderDoc.exists()) {
        ...
        navigation.navigate('PackageDetailsLiv', { scannedData: trackingCode });
      } else {
  ...
  return (
    ...
    <View style={styles.container}> 
        ...
        <>
          <View style={styles.headerContainer}>
            <Image
                          ...
                          resizeMode="contain"
                        />
            <Ionicons name="notifications-outline" size={24} color="#F7F7F7" style={{ marginLeft: 190, marginTop:26}} />
          </View>
      ...
      {/* Tracking Button */}
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("ProfileClient")}>
