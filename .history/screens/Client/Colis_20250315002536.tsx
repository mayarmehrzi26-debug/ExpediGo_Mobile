      ...
      try {
        ...
        const deliveriesList = await Promise.all(
          querySnapshot.docs.map(async (doc) => {
            ...
            const statusnapshot = await getDocs(collection(firebasestore, "adresses"));
            const addressData = statusnapshot.docs.find(addressDoc => addressDoc.id === data.address)?.data();
