      ...
      try {
        ...
        const deliveriesList = await Promise.all(
          querySnapshot.docs.map(async (doc) => {
            ...
            const statusnapshot = await getDocs(collection(firebasestore, "Status"));
            const statusdata = statusnapshot.docs.find(addressDoc => addressDoc.id === data.nomStat)?.data();
          ...
          deliveries.map((delivery) => (
            <View key={delivery.id} style={styles.deliveryCard}>
              ...
              <View style={styles.dateContainer}>
                ...
                <Text style={styles.deliveryValue}>{delivery.status}</Text>
  </View>
              <View style={styles.dateContainer}>
