        ...
        <>
          ...
          <ScrollView>
            <View style={styles.qrContainer}>
              <MaterialIcons name="qr-code" size={100} color="#FFFFFF" />
          ...
          <View style={styles.footerButtonsContainer}>
            <TouchableOpacity style={styles.footerButton}>
              <Text style={styles.footerButtonText}>Get package</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.footerButton}>
              <Text style={styles.footerButtonText}>Delivery status</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.footerButton}>
              <Text style={styles.footerButtonText}>Tracking</Text>
            </TouchableOpacity>
          </View>
        </>
      )}
