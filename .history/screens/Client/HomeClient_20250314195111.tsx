...
const HomeClient: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  onPress={() => navigateToScreen("EnterOrderNumber")}
>
  <Ionicons name="document-text-outline" size={32} color={getIconColor("EnterOrderNumber")} />
  <Text style={getTextStyle("EnterOrderNumber")}>Entrer N°</Text>
</TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingBottom: 100, // Ajoute un espace pour la barre de navigation
  ...
  headerContainer: {
    ...
    marginBottom: 40, // Réduit l'espace en bas
  },
  logo: {
    width: 130,
    height: 60,
  ...
  packageImageContainer: {
    alignItems: 'center',
    marginTop: -80, // Déplace l'image vers le haut
  },
});
