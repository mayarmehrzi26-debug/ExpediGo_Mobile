...
import {
  ...
  Easing,
  Image,
  KeyboardAvoidingView, // Ajout pour gérer le clavier
  Platform,
  StyleSheet,
  Text,
  TextInput,
...
const HomeClient: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardShouldPersistTaps="handled" // Empêche le clavier de fermer inutilement
    >
          ...
          <>
            <View style={styles.headerContainer}>
              ...
              <Ionicons
                ...
                size={24}
                color="#F7F7F7"
                style={{ marginLeft: 190, marginTop: 26 }}
              />
            </View>
            ...
            <View style={styles.buttonContainer}>
              ...
              <TouchableOpacity
                style={styles.button}
                onPress={() => navigation.navigate("Colis")}
              >
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    ...
    marginHorizontal: 20,
    marginTop: 10,
    marginBottom: 20, // Ajout d'une marge en bas pour éviter le débordement
  },
  button: {
