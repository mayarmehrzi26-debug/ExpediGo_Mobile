...
const HomeClient: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  onPress={() => navigation.navigate("EnterOrderNumber")}
>
  <Text style={styles.orderButtonText}>Entrer votre numéro de commande</Text>
</TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  orderButton: {
    ...
    marginHorizontal: 20,
    marginBottom: 20, // Espace avant la navigation
  },
  orderButtonText: {
    color: "#FFFFFF",
    fontSize: 16,
