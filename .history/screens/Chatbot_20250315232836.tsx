...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Utilisez ce chemin pour MaterialIcons
    ...
    return (
        <View style={styles.outerContainer}>
            <View style={styles.botIconContainer}>
                <Icon name="robot" size={50} color="#ffffff" /> {/* Utilisez une icône de robot */}
            </View>
