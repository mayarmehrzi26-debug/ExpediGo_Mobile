...
import Statusbadge2 from "../src/components/Statusbagde2"; // Assurez-vous que le chemin est correct
...
const Livraison: React.FC = () => {
  ...
  const close Menu = () => setMenuVisibleForId(null);
          ...
          searchedDeliveries.map((delivery) => (
            <View key={delivery.id} style={styles.deliveryCard}>
              ...
              <View style={styles.dateContainer}>
                ...
                <Statusbadge2 status={delivery.status} /> 
              </View>
              <View style={styles.dateContainer}>
