...
function Chatbot({ navigation }) {
  ...
  -H "Authorization: Bearer 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" \
  -d '{
    "model": "gpt-4o-mini",
    "store": true,
    "messages": [
