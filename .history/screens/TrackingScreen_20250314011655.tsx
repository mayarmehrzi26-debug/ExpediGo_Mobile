...
export default function TrackingScreen() {
  ...
  // Fonction pour ouvrir l'écran de chat
  const handleChat = () => {
    navigation.navigate('Chat'); // Assurez-vous que le nom de votre écran de chat est correctement défini dans votre navigation
  };
