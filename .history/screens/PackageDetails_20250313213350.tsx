...
const styles = StyleSheet.create({
  ...
  container: {
    flex: 1,
    backgroundColor: '#FC9E60',
    paddingBottom: 200, // Ajuste pour laisser de la place à la carte
  ...
  packageImageContainer: {
    alignItems: 'center',
    marginTop: -40, // Déplace l'image vers le haut
  },
  
  
  card: {
    backgroundColor: '#F8F3DA',
    ...
    shadowRadius: 8,
    elevation: 4,
    position: 'absolute', // Fixe la carte en bas
