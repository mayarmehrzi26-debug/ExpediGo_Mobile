...
import NouvelleLivraison from './NouvelleLivraison';
...
export default function BarcodeScanner({ onClose }: BarcodeScannerProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Afficher les données du colis scanné */}
      {scannedData && (
        <View style={styles.scannedDataContainer}>
          <Text style={styles.scannedDataText}>Code QR Scanné: {scannedData}</Text>
          <Text style={styles.scannedDataText}>Adresse: {NouvelleLivraison.adresse}</Text>
          <Text style={styles.scannedDataText}>Client: {colis.client}</Text>
          <Text style={styles.scannedDataText}>Produit: {colis.produit}</Text>
