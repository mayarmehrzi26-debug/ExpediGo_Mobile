    ...
    const sendMessage = async () => {
        ...
        try {
            const response = await axios.post(
                ...
                {
                    model: "gpt-3.5-turbo", // Modèle OpenAI gratuit
                    messages: [{ role: "user", content: input }],
                },
                {
                    headers: {
                        "Authorization": `Bearer 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`, 
            ...
            setMessages(prevMessages => [{ text: "Erreur : Impossible de contacter l'IA.", sender: "bot" }, ...prevMessages]);
