...
export default function TrackingScreen() {
  ...
  {/* Conteneur blanc (50% du container) */}
...
const styles = StyleSheet.create({
  ...
  container2: {
    flex: 1, // Ajout d'un flex pour prendre 50% de l'écran
    backgroundColor: '#fff',
    borderTopRightRadius: 40,
    borderTopLeftRadius: 40,
  },
  mapContainer: {
    flex: 1, // 50% de l'écran via flex
    marginLeft: 20,
    marginRight: 20,
    marginTop: 20,
    borderRadius: 40,
  ...
  text: {
    ...
    fontWeight: 'bold',
    paddingBottom: 40,
    paddingTop: 20, // Ajustement pour alignement
    alignSelf: 'center',
  },
  distanceContainer: {
    position: 'absolute',
