...
const Livraison: React.FC = () => {
  ...
  const filteredDeliveries = deliveries
    .filter(
      (delivery) =>
        (delivery.status === "En cours de livraison" || delivery.status === "Livré") &&
  ...
  const handleViewDetails = (id: string) => {
    navigation.navigate("DeliveryDetails", { deliveryId: id }); // Navigation vers l'écran de détails avec l'ID de la livraison
  };
