...
import firebaseStore from "@react-native-firebase/firestore"; // Import Firebase Firestore
  ...
  const handleOrder = useCallback(async () => {
    ...
    try {
      ...
      await firebaseStore().collection("orders").add({
        ...
        timestamp: firebaseStore.FieldValue.serverTimestamp(), // Ajouter un timestamp
      });
