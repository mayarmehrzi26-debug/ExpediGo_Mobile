...
function Chatbot({ navigation }) {
    ...
    const sendMessage = async () => {
        ...
        // Ajouter le message de l'utilisateur en haut de la liste
        ...
        try {
            ...
            // Ajouter la réponse du bot en haut de la liste
            setMessages(prevMessages => [{ text: botReply, sender: "bot" }, ...prevMessages]);
        } catch (error) {
            // En cas d'erreur, afficher un message d'erreur
            setMessages(prevMessages => [{ text: "Désolé, une erreur est survenue. Veuillez réessayer plus tard.", sender: "bot" }, ...prevMessages]);
