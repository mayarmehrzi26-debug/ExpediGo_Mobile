...
<View style={styles.section}>
  ...
  <CustomDropdown
    ...
    options={[
      {
        label: selectedProduct ? `Produit sélectionné: ${products.find((product) => product.value === selectedProduct)?.label}` : "Sélectionnez un produit",
        value: selectedProduct ? selectedProduct : "",
        key: "selected_product",
      },
      {
        label: (
          <View key="new_product_option" style={{ flexDirection: "row", alignItems: "center" }}>
            <Icon name="plus-circle" size={18} color="blue" style={{ marginRight: 8 }} />
            <Text>Ajouter un nouveau produit</Text>
          </View>
        ),
        value: "new_product",
        key: "new_product_option",
      },
      ...products.map((product) => ({
        label: (
          <View key={product.value} style={{ flexDirection: "row", alignItems: "center" }}>
            {product.image && (
              <Image
  ...
  />
</View>  <Text style={styles.sectionTitle}>Ajouter un Produit</Text>
  <CustomDropdown
    placeholder="Sélectionnez un produit"
    options={[
      {
