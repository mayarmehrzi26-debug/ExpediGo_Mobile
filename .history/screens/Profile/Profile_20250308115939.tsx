  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        <Image
          source={{ uri: "https://www.flaticon.com/free-sticker/woman_4825112?term=avatar&page=1&position=1&origin=search&related_id=4825112" }} // Remplace par l'URL de l'image de profil
