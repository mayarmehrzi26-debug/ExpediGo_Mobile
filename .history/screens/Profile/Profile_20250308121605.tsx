...
const Profile: React.FC = () => {
  ...
  const menuItems = [
    { label: "Informations personnelles", route: "PersonalInfo" },
    { label: "Informations du Business", route: "BusinessInfo" },
    { label: "Ajouter des collaborateurs", route: "AddCollaborators" },
    { label: "Adresses des pickup", route: "PickupAddresses" },
    { label: "Mauvais clients", route: "BadClients" },
    { label: "Api Key", route: "ApiKey" },
      ...
      <ScrollView contentContainerStyle={styles.menuContainer}>
        {menuItems.map((item, index) => (
          ...
          >
            ...
            <Icon name="chevron-right" size={20} color="#FD5A1E" />
          </TouchableOpacity>
        ))}
      </ScrollView>
