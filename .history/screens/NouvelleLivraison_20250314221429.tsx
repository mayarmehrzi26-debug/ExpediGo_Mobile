...
const saveDelivery = async () => {
  ...
  try {
    ...
    // Generate a unique tracking code (e.g., "TRACK-<ID>-<timestamp>")
    const trackingCode = `TRACK-${newId}-${Date.now()}`;
    ...
    const deliveryData = {
      id: newId,
      trackingCode, // Add tracking code here
      ...
      qrCodeUrl, // Ajouter le code QR ici
    };
