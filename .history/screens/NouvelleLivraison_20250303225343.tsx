    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.clientItem}>
          <Image
            source={{
              uri: "https://cdn.builder.io/api/v1/image/assets/TEMP/8358e1c408acd0dc79b6a890b429446dfc0c08d5",
            }}
            style={styles.clientAvatar}
          />
          <View style={styles.clientInfo}>
            <Text style={styles.clientName}>Diana Bravo</Text>
            <Text style={styles.clientDetail}>email@exemple.com</Text>
            <Text style={styles.clientDetail}>20 547 589</Text>
          </View>
        </View>
      </View>
