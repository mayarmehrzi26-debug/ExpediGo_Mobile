          ...
          searchedOrders.map((order) => (
            <View key={order.id} style={styles.deliveryCard}>
              <View style={styles.cardHeader}>
                ...
                <Menu
                  visible={menuVisibleForId === order.id}
                  onDismiss={closeMenu}
                  anchor={
                    <TouchableOpacity onPress={() => openMenu(order.id)}>
              ...
              <Text style={styles.deliveryClient}>{order.client}</Text>
              <View style={styles.separator} />
              <View style={styles.dateContainer}>
                <Text style={styles.deliverySubtitle}>Status</Text>
                <StatusBadge status={order.status} /> {/* Utiliser order.status */}
              </View>
              <View style={styles.dateContainer}>
                <Text style={styles.deliverySubtitle}>Destination</Text>
                <Text style={styles.deliveryValue}>{order.destination}</Text>
              </View>
              <View style={styles.dateContainer}>
                <Text style={styles.deliverySubtitle}>Date</Text>
                <Text style={styles.deliveryValue}>{order.date}</Text>
              </View>
            </View>
          ))
        ) : (
