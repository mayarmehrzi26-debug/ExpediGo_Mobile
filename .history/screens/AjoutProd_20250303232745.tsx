...
// Main Component
export const AjoutProd: React.FC = () => {
...
<View style={styles.section}>
  ...
  <CustomDropdown 
    ...
    options={[ 
      { label: "Produit 1", value: "produit1" },
      { label: "Produit 2", value: "produit2" },
      { label: "Produit 3", value: "produit3" }
    ]}
    onSelect={(value) => navigation.navigate("AjoutProd", { produit: value })} 
  />
</View>
