...
const SignUpScreen: React.FC = () => {
  ...
  const sendOtp = async (): Promise<void> => {
    ...
    if (!recaptchaVerifier.current || !recaptchaReady) {
      Alert.alert("Erreur", "Veuillez patienter pendant la vérification de sécurité...");
      return;
    }
    ...
    >
      <View style={styles.overlay}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity 
            style={[styles.button, (loading || !recaptchaReady) && styles.disabledButton]} 
            onPress={sendOtp}
