...
const MoneyBagIcon = () => (
  <Svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2">
    <Path d="M12 1C10.9 1 10 1.9 10 3s0.9 2 2 2 2-.9 2-2-0.9-2-2-2zm-4 4h8l2 4H6l2-4zm4 14c-3.31 0-6-2.69-6-6 0-2.5 1.5-4.64 3.67-5.51l-0.73-1.49A7.003 7.003 0 0 0 4 13c0 3.87 3.13 7 7 7s7-3.13 7-7c0-2.17-1.02-4.1-2.59-5.33l-0.73 1.49C16.5 9.36 18 11.5 18 14c0 3.31-2.69 6-6 6zm-1-5v-2h2v2h1l-2 3-2-3h1z"/>
  </Svg>
);
