...
const Pickups: React.FC = () => {
  ...
  const exportSelectedDeliveriesToExcel = async () => {
    ...
    // Créer un nouveau tableau pour les données Excel
    ...
    // Écrire le fichier en tant que Blob
    const excelBuffer = XLSX.write(workbook, { bookType: "xlsx", type: "binary" });
    const filePath = `${RNFS.DocumentDirectoryPath}/livraisons_exportees.xlsx`;

    try {
      // Convertir en binaire et écrire dans le fichier
  ...
  return (
    <View style={styles.container}>
      ...
      <FileExplorer 
        ...
        exportSelectedDeliveries={exportSelectedDeliveriesToExcel} // Passer la fonction d'export
      />
