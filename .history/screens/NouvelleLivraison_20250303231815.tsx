  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <CustomDropdown placeholder="Ajouter un Produit"  options={addressOptions} onSelect={() => {}} />
      </View>

      {/* Payment Section */}
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Paiement</Text>
        <CustomDropdown placeholder="Sélectionnez le statut du paiement"  options={addressOptions} onSelect={() => {}} />
      </View>
