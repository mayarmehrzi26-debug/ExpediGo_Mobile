...
import { Header } from '@react-navigation/stack'; // Import pour la barre de navigation
    ...
    const fetchPackageDetails = async () => {
      ...
      try {
        ...
        if (deliveryDoc.exists()) {
          ...
          const DestinationDoc = await getDoc(doc(firebasestore, 'adresses', deliveryData.destination));
          ...
          const montantValue = montantDoc.exists() ? montantDoc.data()?.amount : "Montant inconnu";
