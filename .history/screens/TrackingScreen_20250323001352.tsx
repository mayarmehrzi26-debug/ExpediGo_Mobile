...
const styles = StyleSheet.create({
  ...
  mapContainer: {
    ...
    borderRadius: 40,
    overflow: 'hidden',
    marginTop:64 // Nécessaire pour appliquer le borderRadius sur la carte
  },
  map: {
    flex: 1,
  },
...
alignSelf:'center'
  ...
  addressContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    marginBottom: 5,aimport { MaterialCommunityIcons, MaterialIcons } from '@expo/vector-icons';
    import * as Location from 'expo-location';
    import { StatusBar } from 'expo-status-bar';
    import React, { useEffect, useState } from 'react';
    ...
    const styles = StyleSheet.create({
      ...
      topContainer: {
        height: '50%', // 50% de l'écran en mauve
        backgroundColor: '#877DAB',
      },
      container2: {
        flex: 1,
      ...
      mapContainer: {
        position: 'absolute',
        top: '25%', // Positionner la carte au milieu
        left: 20,
        right: 20,
        height: '50%', // 50% de l'écran
        borderRadius: 40,
        overflow: 'hidden',
