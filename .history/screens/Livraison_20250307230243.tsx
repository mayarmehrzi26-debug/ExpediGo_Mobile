...
import filterOptions from "../src/components/FilterBar"; // Importer FilterBar
...
const Livraison: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <FilterBar deliveries={deliveries}  <FilterOption
            key={option}
            label={option}
    ...
    <Text style={styles.statusBadge}><View style={styles.iconContainer}><Entypo name="dot-single" size={20} color="white"/></View>
    Livrée</Text>
  </View>      
    <View style={styles.dateContainer}>
