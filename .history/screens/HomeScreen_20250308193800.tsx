...
import CashBox from '.components/CashBox'; // Ajustez le chemin selon votre structure
import StatsList from './components/StatsList'; // Ajustez le chemin selon votre structure
