...
const AddTicket: React.FC = () => {
  ...
  const handleAddTicket = () => {
    ...
    // Si un type est sélectionné, vérifiez les champs supplémentaires
    if (selectedType && (!titre || !description || !selectedService)) {
      alert("Veuillez remplir tous les champs supplémentaires.");
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {/* Afficher les champs supplémentaires si un type est sélectionné */}
        {selectedType && (
          <>
            <View style={styles.section}>
              <TextInput
