    ...
    const sendMessage = async () => {
        ...
        try {
            const response = await axios.post(
                "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyDfqhtsiL68UxOkkXsEV6jdhFmgwkLE9mk",
                {
            ...
            const botReply = response.data.candidates?.[0]?.content?.parts?.[0]?.text || "Réponse non disponible.";
