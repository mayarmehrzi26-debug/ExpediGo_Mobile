...
const MoneyBagIcon = () => (
  <Svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2">
    {/* Remplacez ce chemin par le chemin SVG de votre icône */}
    <Path d="M12 2C8.686 2 6 4.686 6 8v1H4v12h16V9h-2V8c0-3.314-2.686-6-6-6zm0 2c2.21 0 4 1.79 4 4v1H8V8c0-2.21 1.79-4 4-4zm-4 7h8v2H8v-2zm0 4h8v2H8v-2z" />
  </Svg>
);
