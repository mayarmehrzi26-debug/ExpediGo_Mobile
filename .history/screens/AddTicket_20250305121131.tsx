...
import { firestore } from "../src/firebaseConfig"; // Assurez-vous que le chemin est correct
...
const AddTicket: React.FC = () => {
  ...
  const handleAddTicket = async () => {
    ...
    // Créez un objet avec les données du ticket
    const ticketData = {
      type: selectedType,
      ...
      createdAt: new Date(), // Ajoutez un timestamp
    };

    try {
      // Ajoutez le document à la collection "tickets" dans Firestore
      ...
      alert("Une erreur s'est produite lors de l'ajout du ticket.");
    }
  };
