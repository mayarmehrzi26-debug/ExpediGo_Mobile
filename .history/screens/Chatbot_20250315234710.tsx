        ...
        <View style={styles.outerContainer}>
            <View style={styles.botIconContainer}>
                <View style={styles.circle}>
                    <MaterialCommunityIcons name="robot" size={40} color="#800080" /> {/* Couleur mauve */}
                </View>
            </View>
...
const styles = StyleSheet.create({
    ...
    circle: {
        width: 70, // Largeur du cercle
        height: 70, // Hauteur du cercle
        borderRadius: 35, // Pour faire un cercle
