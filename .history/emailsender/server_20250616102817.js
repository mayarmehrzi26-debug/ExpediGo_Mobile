...
app.use(cors({
  origin: [
    ...
    'exp://20.20.0.63:19000',
    'http://20.20.0.63',
    'http://20.20.16.177',
    'http://192.168.160.157',
    'http://192.168.160.160',
...
// Route pour vérifier CORS
app.options('/send-welcome-email', cors()); // Pré-vol CORS explicite

app.post('/send-welcome-email', async (req, res) => {
  console.log('Corps de la requête:', req.body); // Log du contenu
  ...
  try {
    ...
    res.status(500).json({ 
      success: false,
      error: error.message // Renvoyer le message d'erreur complet
    });
  }
});
// Route de test
