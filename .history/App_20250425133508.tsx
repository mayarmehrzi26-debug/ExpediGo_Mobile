...
import AjoutClient from "./src/clients/view/AjoutClientView";
import ClientDetailsView from "./src/clients/view//ClientDetailsView";
import ListeClientsView from "./views/ListeClientsView";
      ...
      <Stack.Navigator initialRouteName="HomeScreen">
        ...
        />
         <Stack.Screen
          ...
          options={{ headerShown: false }}
        />
        <Stack.Screen name="ListeClients" component={ListeClientsView} />
        <Stack.Screen name="ClientDetails" component={ClientDetailsView} />
