...
export const sendWelcomeEmail = functions.firestore.document("clients/{clientId}").onCreate(async (snap: functions.firestore.QueryDocumentSnapshot, context: functions.EventContext) => {
