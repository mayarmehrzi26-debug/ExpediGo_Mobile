  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tableHeader}>
        ...
        <Text style={styles.headerCell}>Etat</Text>
        <Text style={styles.headerCell}>Date d'action</Text>


      </View>

      {loading ? (
        <ActivityIndicator size="large" color="#877DAB" style={styles.loadingIndicator} />
      ) : (
